/* core/nhrp_interface.h - NHRP configuration per interface definitions
 *
...
typedef int (*nhrp_interface_enumerator)(void *ctx,
...
struct nhrp_interface *
nhrp_interface_get_by_protocol(struct nhrp_address *addr);
